...
<body>
	...
	<form action="detailTourServlet?tourId=<%= request.getParameter("tourId") %>" method="post">
		<div id="comment-container">
	        ...
	        <div id="comment-input">
	            <img id="user-image" src="./images/user-avata.png" alt="User Image">
    ...
    <script>
    	...
    	%>
    		function sendComment() {
    			...
    			addComment('<%= name.getFull_name()%>', content);
    		}
    	<%
            }
        %>
    ...
    <div style="padding-left: 700px;">
      <button style="background-color: lightgrey;color:black;" onclick="window.history.back()">Quay lại</button>
    </div>
</body>
</html>
